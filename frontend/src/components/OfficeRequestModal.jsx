/**
 * OfficeRequestModal Component
 *
 * Allows users to specify a quantity and optional notes
 * before adding an office item to their Selection for an Item Request.
 */

import { useState } from "react";
import { useSelection } from "../context/SelectionContext";

function OfficeRequestModal({ item, onClose }) {
...
export default OfficeRequestModal;
