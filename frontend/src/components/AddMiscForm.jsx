// AddMiscForm is the admin modal for creating a new miscellaneous item.
// Used from AdminMisc via the "+ Add New Item" button.
//
// Props:
...
//
// Required fields: item_name, category_id, qty_stock
// All other fields are optional.
// department_id is fetched from /api/core/departments/.
// productImage is only appended when the user has selected a file.

import { useState, useEffect } from "react";
import api from "../api";

function AddMiscForm({ onSuccess, onClose }) {
    ...
    const handleSubmit = (e) => {
        ...
        api.post("/api/miscellaneous/", formData, {
            ...
            .catch((err) => alert(err.response?.data?.error || "Failed to create item."));
    };
            ...
            <div className="bg-white rounded-lg max-w-4xl w-full my-8">
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Quantity */}
                        <div>
                            <label htmlFor="qtyStock" className="block text-sm font-medium text-gray-700 mb-2">
                                Quantity in Stock *
                            </label>
                            <input
                                type="number"
