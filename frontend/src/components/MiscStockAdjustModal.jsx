// MiscStockAdjustModal is the admin form for manually adjusting stock on a single miscellaneous item.
//
// Props:
//   item      - the miscellaneous item whose stock is being adjusted
...
function MiscStockAdjustModal({ item, onClose, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await api.patch(`/api/miscellaneous/update-stock/${item.id}/`, {
                action,
                quantity,
...
export default MiscStockAdjustModal;
