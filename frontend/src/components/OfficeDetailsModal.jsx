// OfficeDetailsModal shows the full product record for a single office item.
//
// Props:
//   item      - the office item object to display; returns null immediately if not provided
...
//
// State:
//   showEditForm - when true, the modal swaps its content for EditOfficeForm
//
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {item.unit_price && (
                                    <div>
                                        ...
                                        <p className="font-medium text-wa-navy">${item.unit_price}</p>
                                    </div>
                                )}
