// EditMiscForm is the admin modal for editing an existing miscellaneous item.
// Pre-fills all fields from the current item data.
//
// Props:
//   item      - the miscellaneous item object to edit
...
function EditMiscForm({ item, onClose, onSuccess }) {
    ...
    const handleSubmit = (e) => {
        ...
        api.patch(`/api/miscellaneous/update/${item.id}/`, formData, {
