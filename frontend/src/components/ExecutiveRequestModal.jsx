/**
 * ExecutiveRequestModal Component
 *
 * Allows users to specify a quantity and optional notes
 * before adding an executive item to their Selection for an Item Request.
 *
 * Uses the item's real unit_price (falling back to 0 if unset, since
 * unit_price is optional on ExecutiveItem unlike Gift).
 */

import { useState } from "react";
import { useSelection } from "../context/SelectionContext";

function ExecutiveRequestModal({ item, onClose }) {
...
export default ExecutiveRequestModal;
