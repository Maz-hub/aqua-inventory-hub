...
function AdminRequests() {
    ...
    const handleAddItem = (requestId) => {
        ...
        if (newItemQty > selectedItem?.qty_stock) {
            alert(`Only ${selectedItem?.qty_stock} items available in stock.`);
            return;
        }
                ...
                <div className="space-y-4">
                    {filteredRequests.map((request) => (
                        ...
                        >
                            ...
                            >
                                {/* Top row: Request # and status badge */}
                                <div className="flex items-center justify-between mb-3">
                                    <span className="font-bold text-wa-navy">
                                        Request #{request.id}
                                    </span>
                                    <span
                                        className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${STATUS_STYLES[request.status]}`}
                                    >
                                            ...
                                            >
                                                ...
                                                <div className="flex items-start justify-between gap-2 mb-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-red-400 hover:text-red-600 cursor-pointer transition-colors shrink-0"
                                                        title="Remove item"
                                                    >
                                                        <svg
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="w-full">
                                                    <select
                                                        ...
                                                        className="form_input w-full text-sm"
                                                    >
                                                        <option value="">
                                                            Select category...
                                                        </option>
                                                ...
                                                {newItemCategory && (
                                                    <div className="w-full">
                                                        <select
                                                            ...
                                                            className="w-full max-w-full text-sm border border-gray-200 rounded-lg p-2 focus:outline-none focus:border-wa-blue bg-white cursor-pointer"
                                                            disabled={
                                                                loadingItems
                                                            }
                                                        >
