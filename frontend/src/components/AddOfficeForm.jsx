// AddOfficeForm is the admin modal for creating a new office item.
// Used from AdminOffice via the "+ Add New Item" button.
//
// Props:
...
function AddOfficeForm({ onSuccess, onClose }) {
